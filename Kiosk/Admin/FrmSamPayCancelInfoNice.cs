...
namespace Kiosk
{
    public partial class FrmSamPayCancelInfoNice : Form
    {
        ...
        public FrmSamPayCancelInfoNice()
        {
            InitializeComponent();
        }

        public FrmSamPayCancelInfoNice(string appDate, string appRecNo, string appNo, string appMonth, string appAmt, string salesDate)
        {
            InitializeComponent();
