...
namespace Kiosk
{
    public partial class FrmSamPayMentDaou : Form
    {
        TcpClient client;
        ...
        public FrmSamPayMentDaou()
        {
            InitializeComponent();
        }

        public FrmSamPayMentDaou(Bitmap bitmap, List<decimal> danga, string totalAmt, string month, string msg)
        {
            InitializeComponent();
            bgBitmap = bitmap;
        ...
        private void FrmSamPayMentDaou_Load(object sender, EventArgs e)
        {
        ...
        private void FrmSamPayMentDaou_FormClosing(object sender, FormClosingEventArgs e)
        {
            isConnected = false;
        ...
        private void SamPayApp(object sender)
        {
            try
            {
                ...
                //UtilHelper.cardInfo.URL = @"System\wav\samsung.mp3";
