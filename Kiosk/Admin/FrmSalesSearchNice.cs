...
namespace Kiosk
{
    public partial class FrmSalesSearchNice : Form
    {
        ...
        public FrmSalesSearchNice()
        {
            InitializeComponent();
        }

        public FrmSalesSearchNice(Bitmap bitmap)
        {
            InitializeComponent();
            this.BackgroundImage = bitmap;
            salehDao.BRAND = saledDao.BRAND = vanDataDao.BRAND = menuListCfgDao.BRAND = StoreInfo.BrnadCode;
            //salehDao.BRAND = saledDao.BRAND = vanDataDao.BRAND = menuListCfgDao.BRAND = "00003";
            salehDao.STORE = saledDao.STORE = vanDataDao.STORE = menuListCfgDao.STORE = StoreInfo.StoreCode;
        ...
        private void FrmSalesSearch_Load(object sender, EventArgs e)
        {
            ...
            panelList_Click(lblTheDaySales, null);
        }
        ...
        private void panelList_Click(object sender, EventArgs e)
        {
            ...
            switch (ctrlName)
            {
                case "lblTheDaySales":
                    ...
                    PanelListInit();
                    panelTheDaySales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblTheDaySales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    lblDash.Visible = false;
                    lblEndDate.Visible = false;
                    nSelectIndex = 0;
                ...
                case "lblOneDaySales":
                    ...
                    PanelListInit();
                    panelOneDaySales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblOneDaySales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                ...
                case "lblMonthSales":
                    ...
                    PanelListInit();
                    panelMonthSales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblMonthSales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    lblDash.Visible = true;
                    lblEndDate.Visible = true;
                    nSelectIndex = 2;
                ...
                case "lblItemSales":
                    ...
                    PanelListInit();
                    panelItemSales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblItemSales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    nSelectIndex = 3;
                    lblDash.Visible = true;
                    lblEndDate.Visible = true;
                ...
                case "lblGrpSales":
                    ...
                    PanelListInit();
                    panelGrpSales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblGrpSales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    nSelectIndex = 4;
                    lblDash.Visible = true;
                    lblEndDate.Visible = true;
                ...
                case "lblSalesCancel":
                    ...
                    PanelListInit();
                    panelSalesCancel.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblSalesCancel.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    nSelectIndex = 5;
                    lblDash.Visible = false;
                    lblEndDate.Visible = false;
                ...
                case "lblBuySales":
                    ...
                    PanelListInit();
                    panelBuySales.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblBuySales.ForeColor = Color.White;
                    txtBoxReport.Clear();
                    nSelectIndex = 6;
                    lblDash.Visible = true;
                    lblEndDate.Visible = true;
                ...
                case "lblABC":
                    ...
                    PanelListInit();
                    panelABC.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblABC.ForeColor = Color.White;
                    nSelectIndex = 8;
                    txtBoxReport.Clear();
                    lblDash.Visible = true;
                    lblEndDate.Visible = true;
                ...
                case "lblItemList":
                    ...
                    panelItemList.BackgroundImage = Properties.Resources.btn_bg_300X100;
                    lblItemList.ForeColor = Color.White;
                    lblDash.Visible = false;
                    lblEndDate.Visible = false;
                    nSelectIndex = 9;
                    GetMenuList();
        ...
        {
            panelTheDaySales.BackgroundImage = null;
            panelOneDaySales.BackgroundImage = null;
            panelMonthSales.BackgroundImage = null;
            panelItemSales.BackgroundImage = null;
            panelGrpSales.BackgroundImage = null;
            panelSalesCancel.BackgroundImage = null;
            panelBuySales.BackgroundImage = null;
            panelABC.BackgroundImage = null;
            panelItemList.BackgroundImage = null;

            lblTheDaySales.ForeColor = Color.RoyalBlue;
            lblOneDaySales.ForeColor = Color.RoyalBlue;
            lblMonthSales.ForeColor = Color.RoyalBlue;
            lblItemSales.ForeColor = Color.RoyalBlue;
            lblGrpSales.ForeColor = Color.RoyalBlue;
            lblSalesCancel.ForeColor = Color.RoyalBlue;
            lblBuySales.ForeColor = Color.RoyalBlue;
            lblABC.ForeColor = Color.RoyalBlue;
            lblItemList.ForeColor = Color.RoyalBlue;
        ...
        private void OneDaySalesPrint()
        {
            ...
            try
            {
                ...
                serialPortReport.Parity = System.IO.Ports.Parity.None;
                serialPortReport.StopBits = System.IO.Ports.StopBits.One;
                serialPortReport.Encoding = Encoding.Default;
                ...
                {
                    serialPortReport.WriteLine(string.Format("{0, -46}", "[" + oneDaySales.date[i].Substring(6, 2) + " 일]"));
        ...
        private void MonthSalesPrint()
        {
            ...
            try
            {
                ...
                {
                    serialPortReport.WriteLine(string.Format("{0, -46}", "[" + monthSales.date[i] + " 월]"));
        ...
        private void ItemSalesPrint()
        {
            ...
            try
            {
                ...
                serialPortReport.WriteLine(string.Format("{0}{1}{2}", PaddingBySpace("품목", 23, false),
                       PaddingBySpace("수량", 18, true), PaddingBySpace("금액", 10, true)));
                serialPortReport.WriteLine(EqualGrid(46, "="));
                ...
                for (int i = 0; i < itemSales.itemName.Count; i++)
                {
                    ...
                    serialPortReport.WriteLine(string.Format("{0:28}\t{1, 3}{2, 8}", UtilHelper.PadingLeftBySpace(itemSales.itemName[i], 28),
                        itemSales.quan[i], string.Format("{0:##,##0}", itemSales.amt[i])));
                }
                serialPortReport.WriteLine(EqualGrid(46, "-"));
                serialPortReport.WriteLine(string.Format("{0, -16}\t{1, 3}\t{2, 5}", "합계\t", itemSales.totCnt, string.Format("{0:##,##0}", Convert.ToDecimal(itemSales.totAmt))));
                serialPortReport.WriteLine("\r\n");
        ...
        private void GrpSalesPrint()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < grpSales.grpName.Count; i++)
                {
                    ...
                    //    grpSales.grpName[i] += "\t";
                    serialPortReport.WriteLine(string.Format("{0:23}\t{1, 3}\t{2, 15}", UtilHelper.PadingLeftBySpace(grpSales.grpName[i],23), grpSales.quan[i],
        ...
        private void SalesCancelPrint()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < salesCancel.receNo.Count; i++)
                {
                    ...
                    serialPortReport.WriteLine(string.Format("{0}    {1}   {2}{3, 7}", salesCancel.date[i], salesCancel.receNo[i], salesCancel.cardName[i],
                        salesCancel.amt[i]));
                }
        ...
        private void InpNmSalesPrint()
        {
            ...
            try
            {
                ...
                sTmpDate[0], sTmpDate[1], sTmpDate[2], eTmpDate[0], eTmpDate[1], eTmpDate[2]), "KIOSK: " + StoreInfo.StoreDesk));
                serialPortReport.WriteLine(EqualGrid(46, "="));
                serialPortReport.WriteLine(string.Format("{0,-14}{1, 12}{2, 10}", PaddingBySpace("매입사", 14, false),
                           PaddingBySpace("승인건수", 12, false), PaddingBySpace("금액", 10, true)));
                serialPortReport.WriteLine(EqualGrid(46, "="));

                for (int i = 0; i < inpNm.inpName.Count; i++)
                {
                    serialPortReport.WriteLine(string.Format("{0:25}\t{1, 8}\t{2, 8}", UtilHelper.PadingLeftBySpace(inpNm.inpName[i].Trim(),25), inpNm.quan[i].ToString(),
                        string.Format("{0:##,##0}", Convert.ToDecimal(inpNm.amt[i]))));
                }
                serialPortReport.WriteLine(EqualGrid(46, "-"));
                serialPortReport.WriteLine(string.Format("{0, -12}\t{1, 8}\t{2, 8}", "합계\t", inpNm.totCnt, string.Format("{0:##,##0}", Convert.ToDecimal(inpNm.totAmt))));
        ...
        private void ABCReportPrint()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < abcReport.itemName.Count; i++)
                {
                    if(abcReport.itemName[i].Length >= 10)
                    {
                        serialPortReport.WriteLine(string.Format("{0, -2}{1:43}", abcReport.abc[i],
                            UtilHelper.PadingLeftBySpace(abcReport.itemName[i], 43)));
                        serialPortReport.WriteLine(string.Format("{0:26}{1, 10}   {2, 3}", UtilHelper.PadingRightBySpace(abcReport.quan[i],26), abcReport.amt[i], abcReport.per[i]));
                    }
                    else
                        serialPortReport.WriteLine(string.Format("{0, -2}{1:21}\t{2, 3}{3, 10}   {4, 3}", abcReport.abc[i],
                            UtilHelper.PadingLeftBySpace(abcReport.itemName[i], 21),
                    ...
                    if (msgBox.ShowDialog() == DialogResult.OK)
                    {
                        if (menuListCfgDao.MenuListCfgSoldOutUpdateL("Y", grpName, proName))
                        {
                            if (menuListCfgDao.MenuListCfgSoldOutUpdate("Y", grpName, proName))
                            {
                                ...
                                if (FrmMain.menuListToGoCfg is IFormMessage)
                                    (FrmMain.menuListToGoCfg as IFormMessage).Receive(null, "SOLDOUT-" +
                                        string.Format("{0}:{1}:{2}:{3}:{4}", page, no, grpName, proName, "Y"));
                            }
                    ...
                    if (msgBox.ShowDialog() == DialogResult.OK)
                    {
                        if (menuListCfgDao.MenuListCfgSoldOutUpdateL("N", grpName, proName))
                        {
                            if (menuListCfgDao.MenuListCfgSoldOutUpdate("N", grpName, proName))
                            {
                                ...
                                if (FrmMain.menuListToGoCfg is IFormMessage)
                                    (FrmMain.menuListToGoCfg as IFormMessage).Receive(null, "SOLDCANCEL-" +
                                        string.Format("{0}:{1}:{2}:{3}:{4}", page, no, grpName, proName, "N"));
                            }
                        }
                    }
