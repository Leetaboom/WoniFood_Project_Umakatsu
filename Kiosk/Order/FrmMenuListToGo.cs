...
namespace Kiosk
{
    public partial class FrmMenuListToGo : Form, IFormMessage
    {
        //메인폼 통신용 이벤트
        ...
        public FrmMenuListToGo()
        {
            InitializeComponent();           
        }

        public FrmMenuListToGo(FrmMain main)
        {
            InitializeComponent();

            this.frmMain = main;
            this.frmMain.sendValueEventToGo += new FrmMain.SendValueHandler(frmMain_sendValueEvent);
        ...
        private void GetMenuListCfgSelect()
        {
            ...
            {
                nGrpIndex = i;
                bool isExceptedGroup = false;

                foreach(string str in StoreInfo.ExceptMenuGrp)
                {
                    if (grpInfo.grpBoxLabelList[i].Text.IndexOf(str) >= 0)
                    {
                        isExceptedGroup = true;
                        break;
                    }
                }
                                    ...
                                    if (dt.Rows.Count != 0)
                                    {
                                        using (DataTableReader dtr = new DataTableReader(dt))
                                        {
                                            while (dtr.Read())
                                            {
                                                ...
                                                {
                                                    foreach (string str in StoreInfo.ExceptMenu)
                                                    {
                                                        if (dtr["MT_TNAM"].ToString().IndexOf(str) >= 0)
                                                        {
                                                            isExcept = true;
                                                            break;
                                                        }
                                                    ...
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuTitle[curIdx].Text = dtr["MT_TNAM"].ToString();
                                                    if (Encoding.Default.GetBytes(dtr["MT_TNAM"].ToString()).Length >= 22)
                                                        ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuTitle[curIdx].Font = new Font("나눔스퀘어", 15, FontStyle.Bold);
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuTCode[curIdx] = dtr["MT_TCOD"].ToString();
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuImgBox[curIdx].BackgroundImage =
                                                        ImageLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuImgBox[curIdx].BackgroundImageLayout =
                                                        ImageLayout.Stretch;
                                                    MenuItemAmt(dtr["MT_TNAM"].ToString(), menuGrpList[i].type, dtr["MT_TCOD"].ToString(), j, curIdx);
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuMemo[curIdx] = MemoLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());
                                                }

                                                if (dtr["MT_SOLDYN"].ToString().CompareTo("Y") == 0)
                                                {
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].soldOut[curIdx] = true;
                                                    ((MenuTypeGrp1)menuGrpList[i]).menuGrpType1[j].menuBox[curIdx].Enabled = false;
                                        ...
                                        using (DataTableReader dtr = new DataTableReader(dt))
                                        {
                                            while (dtr.Read())
                                            {
                                                ...
                                                if (dtr["MT_TNAM"].ToString().Length != 0)
                                                {
                                                    ...
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuTitle[curIdx].Text = dtr["MT_TNAM"].ToString();
                                                    if (Encoding.Default.GetBytes(dtr["MT_TNAM"].ToString()).Length >= 22)
                                                        ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuTitle[curIdx].Font = new Font("나눔스퀘어", 15, FontStyle.Bold);
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuTCode[curIdx] = dtr["MT_TCOD"].ToString();
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuImgBox[curIdx].BackgroundImage =
                                                        ImageLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuImgBox[curIdx].BackgroundImageLayout =
                                                        ImageLayout.Stretch;
                                                    MenuItemAmt(dtr["MT_TNAM"].ToString(), menuGrpList[i].type, dtr["MT_TCOD"].ToString(), j, curIdx);
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuMemo[curIdx] = MemoLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());
                                                }

                                                if (dtr["MT_SOLDYN"].ToString().CompareTo("Y") == 0)
                                                {
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].soldOut[curIdx] = true;
                                                    ((MenuTypeGrp2)menuGrpList[i]).menuGrpType2[j].menuBox[curIdx].Enabled = false;
                                        ...
                                        using (DataTableReader dtr = new DataTableReader(dt))
                                        {
                                            while (dtr.Read())
                                            {
                                                ...
                                                if (dtr["MT_TNAM"].ToString().Length != 0)
                                                {
                                                    ...
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuTitle[curIdx].Text = dtr["MT_TNAM"].ToString();
                                                    if (Encoding.Default.GetBytes(dtr["MT_TNAM"].ToString()).Length >= 22)
                                                        ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuTitle[curIdx].Font = new Font("나눔스퀘어", 15, FontStyle.Bold);
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuTCode[curIdx] = dtr["MT_TCOD"].ToString();
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuImgBox[curIdx].BackgroundImage =
                                                        ImageLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuImgBox[curIdx].BackgroundImageLayout =
                                                        ImageLayout.Stretch;
                                                    MenuItemAmt(dtr["MT_TNAM"].ToString(), menuGrpList[i].type, dtr["MT_TCOD"].ToString(), j, curIdx);
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuMemo[curIdx] = MemoLoad(dtr["MT_TNAM"].ToString(), dtr["MT_TCOD"].ToString());

                                                }

                                                if (dtr["MT_SOLDYN"].ToString().CompareTo("Y") == 0)
                                                {
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].soldOut[curIdx] = true;
                                                    ((MenuTypeGrp3)menuGrpList[i]).menuGrpType3[j].menuBox[curIdx].Enabled = false;
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    using (DataTableReader dtr = new DataTableReader(dt))
                    {
                        while (dtr.Read())
                        {
                            ...
                            //메뉴 타입 2 : 항목 4개
                            //메뉴 타입 3 : 항목 1개
                            if (isCuttingMenu && dtr["PT_OPNM"].ToString() == "단품")
                                continue;
                            switch (i)
                            {
                                case 0:
        ...
        public void Receive(Form frm, string msg)
        {
            ...
            else if (tmp[0].CompareTo("SOLDOUT") == 0)
            {
                ...
                {
                    case "1":
                        for (int page = 0; page < ((MenuTypeGrp1)menuGrpList[grpNum.ToInteger()]).menuGrpType1.Length; page++)
                        {
                            bool isChanged = false;
                            for (int no = 0; no < ((MenuTypeGrp1)menuGrpList[grpNum.ToInteger()]).menuGrpType1[page].menuBox.Count; no++)
                            {
                                if (((MenuTypeGrp1)menuGrpList[grpNum.ToInteger()]).menuGrpType1[page].menuTitle[no].Text.CompareTo(proName) == 0)
                                {
                    ...
                    case "2":
                        for (int page = 0; page < ((MenuTypeGrp2)menuGrpList[grpNum.ToInteger()]).menuGrpType2.Length; page++)
                        {
                            bool isChanged = false;
                            for (int no = 0; no < ((MenuTypeGrp2)menuGrpList[grpNum.ToInteger()]).menuGrpType2[page].menuBox.Count; no++)
                            {
                                if (((MenuTypeGrp2)menuGrpList[grpNum.ToInteger()]).menuGrpType2[page].menuTitle[no].Text.CompareTo(proName) == 0)
                                {
                    ...
                    case "3":
                        for (int page = 0; page < ((MenuTypeGrp3)menuGrpList[grpNum.ToInteger()]).menuGrpType3.Length; page++)
                        {
                            bool isChanged = false;
                            for (int no = 0; no < ((MenuTypeGrp3)menuGrpList[grpNum.ToInteger()]).menuGrpType3[page].menuBox.Count; no++)
                            {
                                if (((MenuTypeGrp3)menuGrpList[grpNum.ToInteger()]).menuGrpType3[page].menuTitle[no].Text.CompareTo(proName) == 0)
                                {
