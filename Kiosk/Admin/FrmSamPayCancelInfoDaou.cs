...
namespace Kiosk
{
    public partial class FrmSamPayCancelInfoDaou : Form
    {
        ...
        public FrmSamPayCancelInfoDaou()
        {
            InitializeComponent();
        }

        public FrmSamPayCancelInfoDaou(string appDate, string appRecNo, string appNo, string appMonth, string appAmt)
        {
            InitializeComponent();
        ...
        private void FrmSamPayCancelInfo_Load(object sender, EventArgs e)
        {
            //axShockwaveFlash1.Movie = Directory.GetCurrentDirectory() + @"\System\swf\phone.swf";

            ThreadPool.QueueUserWorkItem(SamPayCancelApp, true);
        }
        ...
        private void FrmSamPayCancelInfoDaou_FormClosing(object sender, FormClosingEventArgs e)
        {
            isConnected = false;
        ...
        private void SamPayCancelApp(object sender)
        {
            try
            {
                if (isConnected == true)
